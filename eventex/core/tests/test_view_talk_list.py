...
class TalkListGet(TestCase):
    def setUp(self):
        ...
        speaker = Speaker.objects.create(name='Gabriel Cardoso',
                                         slug='gabriel-cardoso',
                                         website='http://gabrielcardoso.net')
    ...
    def test_html(self):
        contents = [
            ...
            (1, '10:00'),
            (1, '13:00'),
            (2, '/palestrantes/gabriel-cardoso/'),
            (2, 'Gabriel Cardoso'),
        ...
        for count, expect in contents:
            with self.subTest():
                self.assertContains(self.resp, expect, count)
